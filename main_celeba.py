...
def main():
    ...
    trainset = CelebA(root=os.path.join('../intern/GS-WGAN-custom/exp/datasets/celeba'), split='train',
        transform=transform_train, download=False, custom_subset=True)
    testset = CelebA(root=os.path.join('../intern/GS-WGAN-custom/exp/datasets/celeba'), split='test',
